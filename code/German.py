...
class Application(tk.Tk):
    ...
    def configure_basic_tk_properties(self):
        ...
        self.configure(bg="#dededf")

        # Creating and placing Lables for each Frame
        self.lable = tk.Label(
            self.mainFrame1, text="What are we reviewing?", foreground="black",
            background="#ffde5d").place(x=0, width=1920
        )
        self.lable2 = tk.Label(
            self.mainFrame2, text="Answers", foreground="black",
            background="#ffde5d").place(y=0, width=1920
        )
    ...
    def place_all(self):
        ...
        self.output_label.place(x=700, y=80, height=100, width=700)
